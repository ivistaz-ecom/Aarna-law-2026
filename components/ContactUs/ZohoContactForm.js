...
export default function ZohoContactForm({
      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        ...
        <div>
          <label
            ...
            className="mb-2 block text-sm font-medium text-gray-700"
          >
            Details of Your Inquiry <span className="text-red-500">*</span>
          </label>
          <textarea
            id="Message"
            name="Message"
        ...
        {submitStatus && (
          <div
            role="status"
            aria-live="polite"
            className={`rounded border p-4 ${submitStatus.type === "success" ? "border-green-200 bg-green-50 text-green-800" : "border-red-200 bg-red-50 text-red-800"}`}
          >
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-0">
      {showHeading ? (
        <h2 className="mb-6 text-2xl font-semibold text-custom-blue">
          Contact Us
        </h2>
      ) : null}
      {formBlock}
